...
echo "========================="
echo "Running this script will update LEZ's documentation. Before running, confirm that "
...
DOC_SHARED="LEZ v2.1 Model Documentation.docx"  # the file name of the shared version
